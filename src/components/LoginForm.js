    ...
    return(
        <div class="card-body">
            ...
            <form role="form" onSubmit={handleLogin}>
                ...
                <button class="btn btn-facebook btn-block text-uppercase" type="submit" onClick={authenticateWithFacebook}><i class="fab fa-facebook-f mr-2"></i> Sign in with Facebook</button>
